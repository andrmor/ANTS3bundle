...
void AGeoObjectDelegate::crateSpecialRoleWidget()
{
    ...
    QFrame * frCal = new QFrame();
        ...
        gl->addWidget(new QLabel("Origin"), 1, 0);
        gl->addWidget(ledCalOriginX,        1, 1);
        gl->addWidget(ledCalOriginY,        1, 2);
        gl->addWidget(ledCalOriginZ,        1, 3);
        gl->addWidget(new QLabel("Step"),   2, 0);
        gl->addWidget(ledCalStepX,          2, 1);
        gl->addWidget(ledCalStepY,          2, 2);
        gl->addWidget(ledCalStepZ,          2, 3);
        gl->addWidget(new QLabel("Bins"),   3, 0);
        gl->addWidget(leiCalBinsX,          3, 1);
        gl->addWidget(leiCalBinsY,          3, 2);
        gl->addWidget(leiCalBinsZ,          3, 3);
