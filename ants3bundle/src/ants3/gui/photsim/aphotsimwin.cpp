...
void APhotSimWin::on_pbHelpDepositionFile_clicked()
{
    QString txt = ""
                  ...
                  "\n"
                  "To create a file, you can use the following template:\n"
                  "array = [\n"
                  "\t[ [\"gamma\", indexMat, Energy_keV, X_mm, Y_mm, Z_mm, Time_ns, indexVolume],\n"
                  "\t  [\"e-\",    indexMat, Energy_keV, X_mm, Y_mm, Z_mm, Time_ns, indexVolume] ],\n"
                  "\t[ [\"gamma\", indexMat, Energy_keV, X_mm, Y_mm, Z_mm, Time_ns, indexVolume] ]\n"
                  "]\n"
                  "eventLabels = [[0],[1]]\n"
                  "core.save3DArray( array,  fileName,  \"#\", eventLabels )\n"
                  "\n"
                  "Binary file format\n"
                  "-----------------\n"
                  "Event record:\n"
                  ...
                  "]\n"
                  "eventLabels = [[0],[1]]\n"
                  "core.save3DBinaryArray( array,  fileName,  0xff,  ['s', 'i', 'd',   'd','d','d',  'd', 'i'],  0xee,  eventLabels,  ['i'] )\n"
                  "";
