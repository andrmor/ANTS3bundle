...
bool ARootJson::fromJson(ADrawObject & obj, const QJsonObject & json)
{
    ...
    QString SavedType;
    jstools::parseJson(json, "Type", SavedType);
    QString Type = QString(tobj->ClassName());
    if (Type != SavedType) return false;

    jstools::parseJson(json, "Options", obj.Options);
...
{
    QJsonObject js;
    if (jstools::parseJson(json, "Line attributes", js))
    {
        int Color = 1;
        jstools::parseJson(js, "Color", Color);
        obj->SetLineColor(Color);
        int Style = 1;
        jstools::parseJson(js, "Style", Style);
        obj->SetLineStyle(Style);
        int Width = 1;
        jstools::parseJson(js, "Width", Width);
...
{
    QJsonObject js;
    if (jstools::parseJson(json, "Marker attributes", js))
    {
        int Color = 1;
        jstools::parseJson(js, "Color", Color);
        ...
        float Size = 1.0;
        jstools::parseJson(js, "Size", Size);
...
{
    QJsonObject js;
    if (jstools::parseJson(json, "Fill attributes", js))
    {
        int Color = 1;
        jstools::parseJson(js, "Color", Color);
...
{
    QJsonObject js;
    if (jstools::parseJson(json, "Text attributes", js))
    {
        int Align = 11;
        jstools::parseJson(js, "Align", Align);
        obj->SetTextAlign(Align);
        int Color = 1;
        jstools::parseJson(js, "Color", Color);
        obj->SetTextColor(Color);
        int Font = 2;
        jstools::parseJson(js, "Font", Font);
...
{
    QJsonObject jsTop;
    jstools::parseJson(json, "Legend", jsTop);

    QJsonObject jsGeo;
    jstools::parseJson(jsTop, "Geometry", jsGeo);
    double d = 0.5;
    jstools::parseJson(jsGeo, "X1", d);
    obj->SetX1NDC(d);
    jstools::parseJson(jsGeo, "X2", d);
    obj->SetX2NDC(d);
    jstools::parseJson(jsGeo, "Y1", d);
    obj->SetY1NDC(d);
    jstools::parseJson(jsGeo, "Y2", d);
    obj->SetY2NDC(d);
