...
public:
    ...
    bool Fill(std::vector <double> &x, std::vector <double> &t);
    bool Fill(std::vector <double> &x, std::vector <double> &y, std::vector <double> &t);
    bool Fill(std::vector <double> &x, std::vector <double> &y, std::vector <double> &z, std::vector <double> &t); 
...
public:
    ...
    bool Fill(std::vector <double> &x, std::vector <double> &y, std::vector <double> &z, std::vector <double> &t) 
        {return ProfileHist::Fill(x, y, z, t);}
};
