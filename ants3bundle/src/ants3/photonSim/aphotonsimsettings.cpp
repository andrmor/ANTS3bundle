...
void APhotonBombsSettings::writeToJson(QJsonObject & json) const
{
    ...
    {
        QJsonObject js;
        NodeFileSettings.writeToJson(js);
        json["File"] = js;
    }
...
QString APhotonBombsSettings::readFromJson(const QJsonObject & json)
{
    ...
    //File
    {
        ...
        NodeFileSettings.readFromJson(js);
    }
...
bool ANodeFileSettings::isValidated() const
{
    if (FileFormat == Undefined || FileFormat == Invalid) return false;
...
QString ANodeFileSettings::getFormatName() const
{
    switch (FileFormat)
    {
...
void ANodeFileSettings::writeToJson(QJsonObject & json) const
{
    json["FileName"]     = FileName;
    json["NumEvents"]    = NumEvents;
    json["FileFormat"]   = getFormatName();
...
void ANodeFileSettings::readFromJson(const QJsonObject & json)
{
    clear();
