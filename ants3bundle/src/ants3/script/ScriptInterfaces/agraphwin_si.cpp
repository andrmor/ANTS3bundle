    ...
    AWindowInterfaceBase(graphWin), GraphWindow(graphWin)
{
    ...
    Help["getDataFromPlot"] = "Return the data of the first drawn histogram or graph. It is an array of arrays of [X,Y] or [X,Y,Z]";
...
#include "TH1.h"
#include "TH2.h"
QVariantList AGraphWin_SI::getDataFromPlot()
{
    QVariantList vl;
